...
to random-dirty
  ask patches with [ pcolor = white] [
    ifelse dirty-regrowth <= 0
    [
      set pcolor grey
      set dirty-regrowth random dirty-time
    ]
    [set dirty-regrowth dirty-regrowth - 1 ]
  ]
end
...
to setup-obstacles
  ...
  ;;porta
  ask patch -16 -7  [ set pcolor green]
  ask patch -16 -8  [ set pcolor green]
  ask patch -16 -9  [ set pcolor green]
  ask patch -16 -10 [ set pcolor green]
  ask patch -16 -11 [ set pcolor green]
  ask patch -16 -12 [ set pcolor green]

  ;;kitchen
  ask patches with [pxcor > world-width * -0.5 and
                    pxcor < world-width * -0.05 and
                    pycor > world-width * -0.5 and
                    pycor < world-width * -0.38 ]
  [ set pcolor brown ]

  ask patches with [pxcor > world-width * -0.5 and
                    pxcor < world-width * -0.05 and
                    pycor > world-width * -0.2 and
                    pycor < world-width * -0.1 ]
  [ set pcolor brown ]

  ;;couch
  ask patches with [pxcor > world-width * 0.05 and
                    pxcor < world-width * 0.5 and
                    pycor > world-width * 0.08 and
                    pycor < world-width * 0.2 ]
  [ set pcolor brown ]

  ;;TV
  ask patches with [pxcor > world-width *  0.2 and
                    pxcor < world-width *  0.35 and
                    pycor > world-width * -0.5 and
                    pycor < world-width * -0.48 ]
  [ set pcolor brown ]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
"" ""
PENS
"limpeza" 1.0 0 -16777216 true "plot total-cleanliness" "plot total-cleanliness"
"energia gasta" 1.0 0 -2674135 true "" "plot energy-spent"
"utilidade" 1.0 0 -13345367 true "" "plot total-utility"
"insatisfação" 1.0 0 -13840069 true "" "plot total-satisfaction"
...
<experiments>
  ...
  <experiment name="bothCleaners" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="algorithm">
      <value value="&quot;random&quot;"/>
